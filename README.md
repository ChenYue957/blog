...
这是一个高三生的个人技术博客，分享学习笔记、折腾记录和生活碎片。

### 📂 内容分类

- **技术折腾** - 前端开发、服务器、NAS、自动化

- **硬件玩家** - 智能家居、LEGO、无人机、摄影器材

- **MC 服务器** - The Mortal World（尘世）服主日记

- **生活随记** - 骑行、羽毛球、日常摆烂

### 🛠️ 技术栈

`Hexo` `HTML` `前端开发` `服务器运维` `NAS`
...
=======
>>>>>>> b3bcb06e3010ec81beebdf007806bbd86ee40ea5
| 站点        | 地址                                                | 说明        |
| --------- | ------------------------------------------------- | --------- |
